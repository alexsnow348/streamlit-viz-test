...
# Folder selection
folder_path = st.text_input("Enter the folder path containing timelapse images:", "/data/biolab_arralyze_picture_data/20240529 K562-NK cells purified_Killing Assay (9b33)/v3/Run 1/Images/")
...
with col1:
    if os.path.exists(folder_path):
        ...
        folder_selected = st.selectbox("Select a folder", folders, index=0)
